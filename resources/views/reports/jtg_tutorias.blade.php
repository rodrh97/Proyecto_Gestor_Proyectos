...
@section('title',"SIITA - Reportes de Tutorías JTG")
		...
		<div class="row align-items-end">
			<div class="col-lg-8">
				<div class="page-header-title">
					...
					<div class="d-inline">
						<h4 style="text-transform: none;">Reportes de Tutorías de la Jornada de Tutorías Grupales</h4>
			...
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class="breadcrumb-title">
						...
						<li class="breadcrumb-item">Reportes de Tutorías JTG
						</li>
					</ul>
				</div>
			</div>
	...
	<div class="page-body">
		<div class="row">
					...
					<div class="card-block">
						<h4 class="sub-title"><i class="icofont icofont-filter"></i> Filtros</h4>
							...
							<div class="row">
								...
								<div class="col-sm-12 col-xl-4">
									<p>Periodo: </p>
									<input type="text" class="form-control" style="height: 46px; width: 100%;" name="term" id="term" />
								</div>
							</div>
							<div class="row">
								<div class="col-sm-12 col-xl-6">
									<p>Lugar: </p>
									<input type="text" class="form-control" style="height: 46px; width: 100%;" name="place" id="place" />
								</div>
								<div class="col-sm-12 col-xl-6">
									<br /><br />
									<center>
			...
			<div id="results_section" class="col-sm-12">
				<div class="card">
					<div class="card-block">
						<h4 class="sub-title"><i class="fas fa-list-ol"></i> Totales de Tutorias en la Jornada de Tutorias Grupales</h4>
						<div class="row">
							...
							<table style="width:100%;" id="datatable_reports" class="table table-striped table-bordered">
								@if ((!empty($asesorias)))
									<thead id="table_header">
										<tr>
											...
											<th scope="col" style="width: 10%">Periodo</th>
											<th scope="col" style="width: 10%">Lugar</th>
											<th scope="col" style="width: 10%">Resultados</th>
											<th scope="col" style="width: 5%">Necesidades Detectadas</th>
								...
								<tfoot>
									<tr id="table_footer">
										...
										<th style="padding-right: 1.5%" scope="col">Periodo</th>
										<th style="padding-right: 1.5%" scope="col">Lugar</th>
										<th style="padding-right: 1.5%" scope="col">Resultados</th>
										<th style="padding-right: 1.5%" scope="col">Necesidades Detectadas</th>
...
<script>
	...
	$(document).ready(function() {
		...
		var jsFileNameDate = 'Bitácora_Tutorías_JTG_'+date.getDate()+'_'+month+'_'+date.getFullYear();
										...
										return {
											columns: [
			                                    ...
			                                    },
												{
													alignment: 'left',
													italics: false,
													stack: ['BITÁCORA DE ASISTENCIA A TUTORÍAS JTG'+subheader,
									...
									doc['footer']=(function(page, pages) {
										return {
											columns: [
												...
												{
													alignment: 'right',
													text: ['Total de Tutorías: ' + cant_tutorias],
													margin: [20,20]
												},
												{
													alignment: 'right',
	...
	function fillDataTable(is_click=0){
		...
		//por la funcion
		$.ajax({
			url: '{{ route('reports.get_jtg_tutoria_report') }}',
			method: 'POST',
			data: {
			...
			success: function(result) {
				...
				if (tutoria.length === 0) {
					...
					for (var i = 0; i < tutoria.length; i++) {
						...
						switch(tutoria[i]["results_type"]){
							case 0:
								tutoria[i]["results_type"]="Bueno";
								break;
							case 1:
								tutoria[i]["results_type"]="Regular";
								break;
							case 2:
								tutoria[i]["results_type"]="No Competente";
								break;
							default:
								tutoria[i]["results_type"]="No Registrado";
						}

						if(tutoria[i]["detected_needs"]==""){
							tutoria[i]["detected_needs"]="No Registrado"
						}
						...
						dt_reports.row.add([
							...
							tutoria[i]["term"],
							tutoria[i]["place"],
							tutoria[i]["results_type"],
							tutoria[i]["detected_needs"],
							tutoria[i]["date_attention"],
							tutoria[i]["state"],
						]).draw();
					}

					$("#cant_tutorias").text(cant_tutorias);
