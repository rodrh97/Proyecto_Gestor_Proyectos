		...
		<div class="row align-items-end">
			<div class="col-lg-8">
				<div class="page-header-title">
					...
					<div class="d-inline">
						<h4 style="text-transform: none;">Reportes por programas sin reglas de operación</h4>
			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-block">
						...
						<form id="form" method="POST" action="{{ route('reports.ObtenerDatosSin') }}">
							{!! csrf_field() !!}
				...
				<div class="card">
					<div class="card-block">
                      ...
                      <th scope="col" style="width: 10%">ID</th>
											...
											<!--<th scope="col" style="width: 20%">Estado de proyecto</th>-->
...
<script>
									...
									doc['footer']=(function(page, pages) {
										return {
											columns: [
												...
												{
													alignment: 'right',
													text: ['Asesorías Individuales: ' ],
													margin: [20,20]
												},
												{
													alignment: 'right',
													text: ['Asesorías Grupales: ' ],
													margin: [20,20]
												},
												{
													alignment: 'right',
													text: ['Total de Asesorías: ' ],
													margin: [20,20]
												},
												{
													alignment: 'right',
  ...
  /*
    ...
    console.log("adios");
		...
		//por la funcion
		$.ajax({
			url: '{{ route('reports.ObtenerDatosSin') }}',
			method: 'POST',
			data: {
      ...
      console.log("hola");
				if(asesoria.length==0){
					...
					for (var i = 0; i < asesoria.length; i++) {
						...
						dt_reports.row.add([
                "1",
								asesoria[i]["name_program"],
								asesoria[i]["applicants_name"]+" "+asesoria[i]["applicants_last_name"] + " " + asesoria[i]["applicants_second_last_name"],
								asesoria[i]["folio"],
								//asesoria[i]["status"],
								asesoria[i]["last_modificacion"]
						]).draw();
					}
