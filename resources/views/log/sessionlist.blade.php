							...
							<table style="width:100%;" id="custom_datatable" class="table table-striped table-bordered">
								...
								<tbody>
									...
									<tr>
											...
											<td>
											<center>
												<a href="{{ route('sessions.show', ['id' => $session->id]) }}" class="btn btn-warning" title="Ver Detalles" style="margin: 5px;" data-toggle="tooltip" data-placement="top"><span class="icofont icofont-eye-alt"></span></a>
											</center>
											</td>
									</tr>
									@endforeach
