		...
		<div class="row align-items-end">
			<div class="col-lg-8">
				<div class="page-header-title">
					...
					<div class="d-inline">
						<h4 style="text-transform: none;">Detalles de Tipo Sesión</h4>
						<span style="text-transform: none;">Formulario para la visualización de datos de un movimiento de tipo de sesión.</span>
					</div>
				</div>
			</div>
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class="breadcrumb-title">
						...
						<li class="breadcrumb-item"><a href="{{ route('log.sessionlist') }}">Historial de Sesiones</a>
						</li>
						<li class="breadcrumb-item">Detalles
						</li>
					</ul>
				</div>
			</div>
											...
											<div class="col-sm-12 user-detail">
												...
												<div class="row">
														@switch($log[0]->action)
															@case(1)
															<div class="col-sm-4">
																<h6 class="f-w-400 m-b-30"><i class="icofont icofont-login"></i>Acción :</h6>
															</div>
															<div class="col-sm-8">
																<h6 class="m-b-30">Inicio de Sesión</h6>
															@break
															@case(2)
															<div class="col-sm-4">
																<h6 class="f-w-400 m-b-30"><i class="icofont icofont-logout"></i>Acción :</h6>
															</div>
															<div class="col-sm-8">
																<h6 class="m-b-30">Cierre de Sesión</h6>
															@break
														@endswitch
													</div>
												</div>
