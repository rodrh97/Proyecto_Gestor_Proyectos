		...
		<div class="row align-items-end">
			<div class="col-lg-8">
				<div class="page-header-title">
					...
					<div class="d-inline">
						<h4 style="text-transform: none;">Añadir programa sin reglas de operación</h4>
			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-block">
						<form  method="POST" action="{{ route('programs.createWithoutRulesOperation') }}" enctype="multipart/form-data">
							{!! csrf_field() !!}
              
              
              <input type="hidden" id="families_input" name="families_input" value="{{ old('families_input')}}" />
							<input type="hidden" id="archivos_data" name="archivos_data" value="{{ old('archivos_data')}}" />
                ...
                <label class="col-sm-2 col-form-label" for="unit_ejecutora">Unidad Ejecutora:</label>
							...
							<div class="form-group row">
								...
								<div class="col-sm-4">
									<input type="date" class="form-control" name="start_date" placeholder="Fecha de Inicio" value="{{ old('start_date') }}" title="Fecha de Inicio de programa" required>
                ...
                <label class="col-sm-2 col-form-label" for="finish_date">Fecha de Cierre:</label>
								<div class="col-sm-4">
									<input type="date" class="form-control" name="finish_date" placeholder="Fecha de Cierre" value="{{ old('finish_date') }}" title="Fecha de Cierre de programa" required>
              ...
              <div class="form-group row">
								...
								<div class="col-sm-10">
                  <textarea type="text" rows="8" cols="50" class="form-control" name="p_amount_max"   placeholder="Ej. El monto máximo de apoyo federal por persona física será de hasta $500,000.00 (Quinientos mil pesos 00/100 M.N.)." title="Cantidad Máxima por Persona Física" required>{{ old('p_amount_max') }}</textarea>
              ...
              <div class="form-group row">
								...
								<div class="col-sm-10">
                  <textarea type="text" rows="8" cols="50" class="form-control" name="m_amount_max"   placeholder="Ej. El monto máximo de apoyo federal por persona moral será de hasta $5,000,000.00 (Cinco millones de pesos 00/100 M.N.)." title="Cantidad Máxima por Persona Moral" required>{{ old('m_amount_max') }}</textarea>
								...
								<div class="col-sm-10">
									<div class="file-upload">
										<div id="image-upload-wrap1" class="image-upload-wrap">
											<input id="image_input_1" class="file-upload-input" type='file' name="file" onchange="readURLForComponents1(this);" accept="file/*" required/>
											<div style="padding-top:40px" onclick="$('#image_input_1').trigger('click' )">
												<center>
													<i style="font-size: 60px;" class="fas fa-cloud-upload-alt drag-icon"></i>
												</center>
											</div>
             ...
             <div class="form-group row">
              ...
              <!--<div class="form-group row">
								...
								<div class="col-sm-3">
									<input type="text" class="form-control" name="nombre_anexo" id="nombre_anexo" placeholder="Nombre del anexo" title="Nombre del anexo">
								</div>
                
                <label class="col-sm-1 col-form-label" >Archivo:</label>
								<div class="col-sm-4">
									<input type="file" class="form-control" name="archivo_anexo" id="archivo_anexo" placeholder="Archivo del anexo" title="Archivo">
								</div>
                <div class="col-sm-2">
                  <input type="button" class="btn btn-warning" id="add_material_family_btn" value="Añadir anexo">
                </div>
							</div>
              ...
              <div class="row">
                <div class="col-md-12" style="max-height: 340px; overflow-y: auto;">
                  <br />
                  <table id="families_datatable" style="width:100%" class="table table-striped table-bordered">
                    <thead id="table_header">
                      <tr>
                        <th class="all" style="width: 25%" scope="col">Nombre del Anexo</th>
                        <th scope="col">Archivo</th>
                        <th class="all"  style="width: 15%" scope="all">Quitar Anexo</th>
                      </tr>
                    </thead>
                    <tbody></tbody>
                  </table>
              ...
              @if ($errors->has('families_input'))
                <div class="col-form-label" style="color:red;">{{$errors->first('families_input')}}</div>
              @endif
              <br>
              -->
              <hr>
							<br><br>
							<center>
								<a style="color:white" onclick="returnURL('{{ url()->previous() }}')"  class="btn btn-primary col-sm-3"><i class="icofont icofont-arrow-left"></i>Regresar</a>
								<button type="submit" id="guardar" class="btn btn-success col-sm-3"><i class="icofont icofont-check-circled"></i>Guardar Programa</button>
							</center>
