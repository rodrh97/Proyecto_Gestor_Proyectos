			...
			<div class="col-sm-12">
				...
				<div class="card">
					<div class="card-block">
                        ...
                        <div class="row">
                          <div class="col-sm-6">
														<h6 class="f-w-400 m-b-30"><i class="fas fa-cube"></i><strong> Programa no sujeto a reglas de operación</strong></h6>
													</div>
                        </div>
												<div class="row">
													<div class="col-sm-4">
                        ...
                        <div class="row">
													...
													<div class="col-sm-8">
														<h6 class="m-b-30">{{ $program->start_date }}</h6>
													</div>
												</div>
                        ...
                        <div class="row">
													...
													<div class="col-sm-8">
														<h6 class="m-b-30">{{ $program->finish_date }}</h6>
													</div>
												</div>
                        
                        <div class="row">
													<div class="col-sm-4">
														<h6 class="f-w-400 m-b-30"><i class="fas fa-cube"></i>Monto máximo por persona física:</h6>
													</div>
													<div class="col-sm-8">
														<h6 class="m-b-30">{{ $program->p_amount_max }}</h6>
													</div>
												</div>
                        <div class="row">
													<div class="col-sm-4">
														<h6 class="f-w-400 m-b-30"><i class="fas fa-cube"></i>Monto máximo por persona moral:</h6>
													</div>
													<div class="col-sm-8">
														<h6 class="m-b-30">{{ $program->m_amount_max }}</h6>
													</div>
												</div>
                        ...
                        <div class="row">
													<div class="col-sm-4">
														<h6 class="f-w-400 m-b-30"><i class="fas fa-cube"></i>Requerimientos Específicos:</h6>
													</div>
													<div class="col-sm-8">
														<a target="_blank" href="{{asset($program->specific_requirements)}}" class="btn btn-inverse col-lg-2" title="Visualizar requerimientos específicos" ><span class="fas fa-eye"></span></a> 
                            <a href="{{url('/programs/downloadSpecific',['id'=>$program->id])}}" class="btn btn-warning col-lg-2" title="Descargar requerimientos específicos"><span class="fas fa-download"></span></a>
													</div>
												</div>
                        <div class="row">
													<div class="col-sm-4">
