            ...
            <div class="row"> 
              ...
              <div class="col-md-12">
                        ...
                        <div class="sidebar">
                          ...
                          <div class="listing listing-1">
                            <div class="listing-section">
                                 ...
                                 <form method="POST" action="/agregar_experiencias/{{auth()->user()->id}}">
                                 {!! csrf_field() !!}
                                 ...
                                 <label>* Puesto</label>
                                 <input type="text" name="position" placeholder="Ej. Practicante" style="color:black" value="{{ old('name') }}" required>
                                 ...
                                 <div class="form-group col-md-12">
                                 <label>* Empresa</label>
                                 <input type="text" name="company" placeholder="Ej. Oracle" style="color:black" value="{{ old('name') }}" required>
                                 @if ($errors->has('inicio'))
										             <div class="col-form-label" style="color:red;">{{$errors->first('name')}}</div>
									               @endif
                                 </div>
                ...
                {!! Form::select('city',['placeholder'=>'Favor de seleccionar un estado'],null,['id'=>'city','class'=>'form-control','style'=>'color:black']) !!}
                                 ...
                                 <input type="date" name="start_date" title="Fecha de Inicio de la experiencia" value="{{ old('start_date') }}" required>
                                 @if ($errors->has('inicio'))
                                 ...
                                 <input type="date" name="finish_date" title="Fecha de Finalización de la experiencia" value="{{ old('finish_date') }}" required>
                                 @if ($errors->has('inicio'))
                                 ...
                                 <textarea rows="15" cols="50" class="form-control" type="text" placeholder="Ej. La experiencia donde se tuvo que analizar información que requiere una empresa para asi poder optar por un diseño de base de datos normalizada y proceder a implementarla" value="{{ old('description') }}" maxlength="1000" style="color:black" name="description" value="{{ old('description') }}" required></textarea>
                                  @if ($errors->has('inicio'))
