...
@section('title',"SIITA - Importar CSV")
		...
		<div class="row align-items-end">
			<div class="col-lg-8">
				<div class="page-header-title">
					...
					<div class="d-inline">
						<h4 style="text-transform: none;">Importar Carrera</h4>
			...
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class="breadcrumb-title">
						...
						<li class="breadcrumb-item"><a href="{{ route('imports.list') }}">Carreras</a>
						</li>
					...
					<div class="card-block">
						<form id="form" method="POST" action="{{ route('imports.store') }}" enctype="multipart/form-data">
							...
							<div class="form-group row">
								<label class="col-sm-2 col-form-label" for="file">SELECCIONE ARCHIVO CSV:</label>
								<div class="col-sm-10">
									<input type="file" class="form-control" id="file" name="file" title="ARCHIVO CSV">
								</div>
							</div>
							...
							<center>
								...
								<button type="submit" class="btn btn-success"><i class="icofont icofont-check-circled"></i>IMPORTAR Carrera</button>
							</center>
						</form>
					</div>
				</div>
