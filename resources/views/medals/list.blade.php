		...
		<div class="row align-items-end">
			<div class="col-lg-8">
				<div class="page-header-title">
					<i class="fa fa-trophy" style="background-color:#5e1287;"></i>
					<div class="d-inline">
...
<div class="main-body">
	...
	<div class="page-header card">
		<div class="row align-items-end">
			<div class="col-lg-8">
				<div class="page-header-title">
					<i class="fa fa-trophy" style="background-color:#fcb650;"></i>
					<div class="d-inline">
						<h4 style="text-transform: none;">Listado de Medallas</h4>
						<span style="text-transform: none;">Lista de todas las medallas registradas en el sistema.</span>
					</div>
