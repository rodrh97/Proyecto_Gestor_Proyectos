		...
		<div class="row align-items-end">
			<div class="col-lg-8">
				<div class="page-header-title">
					...
					<div class="d-inline">
						<h4 style="text-transform: none;">Crear Subcomponente</h4>
						<span style="text-transform: none;">Llene los campos en la parte inferior para registrar un nuevo subcomponente.</span>
					</div>
				</div>
			</div>
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class="breadcrumb-title">
						...
						<li class="breadcrumb-item">Crear Subcomponente
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="col-sm-12">
              ...
              <br><br>
							<center>
								...
								<button type="submit" class="btn btn-success"><i class="icofont icofont-check-circled"></i>Guardar Subcomponente</button>
							</center>
						</form>
					</div>
				</div>
