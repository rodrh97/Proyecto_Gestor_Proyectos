$(document).ready(function () {
    $("#pcoded").pcodedmenu({
        ...
        ThemeBackgroundPattern: 'pattern150',  // pattern1, pattern2, pattern3, pattern4, pattern5, pattern6
        HeaderBackground: 'theme4',  // theme1, theme2, theme3, theme4, theme5  header color
